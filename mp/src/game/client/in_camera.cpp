...
ConVar cam_idealyaw( "cam_idealyaw", "45", FCVAR_ARCHIVE| FCVAR_CHEAT );	 // thirdperson yaw
ConVar cam_idealpitch( "cam_idealpitch", "45", FCVAR_ARCHIVE | FCVAR_CHEAT  );	 // thirperson pitch
